#!/bin/bash
#    Setup Simple PPTP VPN server for CentOS6

printhelp() {

echo "
Usage: ./CentOS6-pptp-iptables.sh [OPTION]
...
example: ./CentOS6-pptp-iptables.sh -u myusr -p mypass
Use without parameter [ ./CentOS6-pptp-iptables.sh ] to use default username and Random password
