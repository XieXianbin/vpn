...
echo "
Usage: ./CentOS7-pptp-firewalld.sh [OPTION]
...
example: ./CentOS7-pptp-firewalld.sh -u myusr -p mypass
Use without parameter [ ./CentOS7-pptp-firewalld.sh ] to use default username and Random password
