...
Usage: sh Ubuntu-pptp.sh [OPTION]
...
example: sudo bash Ubuntu-pptp.sh -u vpn -p mypass

Use without parameter [ sudo bash Ubuntu-pptp.sh ] to use default username and Random password
